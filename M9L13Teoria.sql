...
create function public.sales_archived_function()
returns trigger
language plpgsql
    as
    $$
        begin
                if (tg_op ='delete') then
                    ...
                    values (old.sal_description, old.sal_date, old.sal_value, old.sal_pr_id, 'd' );
...
create trigger public.trigger_to_sales_archived
